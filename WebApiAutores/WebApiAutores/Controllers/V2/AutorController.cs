...
namespace WebApiAutores.Controllers.V2
{
    ...
    public class AutorController : ControllerBase
    {
        ...
        [HttpGet(Name = "obtenerAutoresV2")] // Todos los autores
        [AllowAnonymous] // permitir uso a anonimos
        [ServiceFilter(typeof(HATEOASAutorFilterAttribute))]
        public async Task<ActionResult<List<AutorLeerDTO>>> Get() // tomamos de ejemplo NO HACER DE ESTA MANERA
        {
        ...
        [HttpGet("{id:int}", Name = "obtenerAutorPorIdV2")] // Autor por id
        [AllowAnonymous]
        [ServiceFilter(typeof(HATEOASAutorFilterAttribute))]
        ...
        [HttpGet("{nombre}", Name = "obtenerAutorPorNombreV2")] // Autores por nombre
        ...
        [HttpPost(Name = "crearAutorV2")] // insert
        ...
        [HttpPut("{id:int}", Name = "actualizarAutorV2")] // Update por id
        ...
        [HttpDelete("{id:int}", Name = "eliminarAutorV2")] // Delete
